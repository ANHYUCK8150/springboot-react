...
public class AddressService {
	...
	public List<TownDto> townList(String search, double range) {
		...
		if (searchArr.length == 1) {
			...
			townInfo = addressRepository.getByCityAndDistrictAndNameAndEtc(searchArr[0], searchArr[1], searchArr[2],
				searchArr[3]);
		}
	...
	public TownDto getNearTown(String latitude, String longitude) {
		Town town = addressRepository.getNearTown(latitude, longitude);
